...
export default function PractitionerReportsPage() {
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-600">All claims submitted for services you provided</p>
          </div>
        </div>
      ...
      <div className="bg-white rounded-lg shadow-sm border border-gray-200 overflow-hidden">
        <table className="min-w-full divide-y divide-gray-200">
          ...
          <tbody className="bg-white divide-y divide-gray-200">
            {[
              { id: 1, serviceDate: '02/15/2024', student: 'Emma Rodriguez', serviceType: 'Speech Therapy', amount: '$125.00', district: 'Fruitvale', status: 'Paid' },
              { id: 2, serviceDate: '02/14/2024', student: 'Marcus Chen', serviceType: 'Occupational Therapy', amount: '$145.00', district: 'Greenfield', status: 'Pending' },
              { id: 3, serviceDate: '02/13/2024', student: 'Sofia Williams', serviceType: 'Speech Therapy', amount: '$125.00', district: 'Valley View', status: 'Approved' },
              { id: 4, serviceDate: '02/12/2024', student: 'Emma Rodriguez', serviceType: 'Speech Therapy', amount: '$125.00', district: 'Fruitvale', status: 'Paid' },
              { id: 5, serviceDate: '02/10/2024', student: 'Lucas Johnson', serviceType: 'Behavioral Support', amount: '$135.00', district: 'Westside', status: 'Rejected' }
            ].map((claim, index) => (
  ...
  if (previewReport) {
    return (
      <Dashboard title="" role="Practitioner">
        {previewReport === 'My Service Claims Report' && <MyServiceClaimsReport />}
        {previewReport === 'Student Progress Report' && (
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              <button 
                onClick={handleBackToReports}
              ...
              <div>
                <h1 className="text-2xl font-bold text-teal-700">Student Progress Report</h1>
                <p className="text-gray-600">Progress tracking for students in your caseload</p>
              </div>
            </div>
            <div className="bg-yellow-50 border border-yellow-200 rounded-md p-6 text-center">
              <h2 className="text-lg font-medium text-yellow-800 mb-2">Report Preview</h2>
              <p className="text-yellow-700">This report will show detailed progress metrics for each student in your caseload, including goal achievement rates and intervention effectiveness.</p>
            </div>
          </div>
        )}
        {previewReport === 'Caseload Summary Report' && (
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              <button 
                onClick={handleBackToReports}
              ...
              <div>
                <h1 className="text-2xl font-bold text-teal-700">Caseload Summary Report</h1>
                <p className="text-gray-600">Overview of your entire caseload and service delivery statistics</p>
              </div>
            </div>
            <div className="bg-yellow-50 border border-yellow-200 rounded-md p-6 text-center">
              <h2 className="text-lg font-medium text-yellow-800 mb-2">Report Preview</h2>
              <p className="text-yellow-700">This report will provide a comprehensive overview of your caseload, including student demographics, service frequencies, and productivity metrics.</p>
            </div>
          </div>
        )}
      </Dashboard>
  ...
  return (
    <Dashboard title="Reports Dashboard" role="Practitioner">
      <div className="space-y-6">
        {/* Header */}
        <div>
          <p className="text-teal-600 text-lg">Access your service reports and generate custom analytics</p>
        </div>
        ...
        {activeTab === 'canned' && (
          <div className="space-y-6">
            <div>
              <h2 className="text-xl font-semibold text-gray-900 mb-2">Practitioner Reports</h2>
              <p className="text-gray-600 mb-6">Reports focused on your services and caseload</p>
          ...
          <div className="space-y-6">
            ...
            <div className="flex justify-between items-center">
              <div>
                ...
                <p className="text-gray-600">Create custom reports for your services and caseload</p>
              </div>
              <div className="flex space-x-3">
