...
export default function CaseloadPage() {
  ...
  const loadCaseloadData = async () => {
    ...
    setIsLoading(true)
    try {
      console.log('Loading caseload data for practitioner:', appUser.id)
  ...
  const loadAvailableStudents = async () => {
    ...
    try {
      // Get all students that are NOT assigned to this practitioner
  ...
  return (
    <Dashboard title="Caseload" role="Practitioner">
